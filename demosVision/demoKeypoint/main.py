...
def visualize_keypoints(image, keypoints, color, radius, connect_skeleton=None, connect_width=None):
    """
...
def main():
    ...
    # Detect keypoints
    keypoints = detect_keypoints(model, person_float, threshold=args.detect_threshold)
